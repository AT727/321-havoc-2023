...
public class InverseArmKinematics {
  ...
  private static final double anchorLength = Constants.Arm.Anchor.kAnchorLength; // 40.3

  private static final double floatLength = Constants.Arm.Floating.kFloatingLength; // 28
